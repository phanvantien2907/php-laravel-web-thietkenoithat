        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">Chi tiết danh mục</div>
                </div>
            </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form>
                                    ...
                                    <div class="form-group">
                                        <label>Levels:</label>
                                        <label>{{$category->seo_keywords}}</label>
                                    </div>
                                    ...
                                    <div class="d-flex">
                                        <a href="{{route('admin.category.edit', $category->category_id)}}" class="btn btn-primary rounded-pill btn-lg me-2 mx-1">Edit</a>
